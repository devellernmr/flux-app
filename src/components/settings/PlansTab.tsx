    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-xs font-medium">
                ...
                <span className="text-white">
                  {(usage.storage / 1024).toFixed(1)}GB Utilizado
                </span>
              </div>
              <Progress
                value={usage.storage > 0 ? 10 : 2}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {plans.map((plan) => (
          <div
            key={plan.id}
            className={`relative group rounded-2xl border p-6 transition-all hover:-translate-y-1 duration-300 ${
              plan.id === currentPlan
          ...
          >
            ...
            <div className="mb-6">
              ...
              <p className="text-xs text-zinc-500 mt-2 h-8">
                {plan.description}
              </p>
            </div>
