                    ...
                    {PLANS.map((p) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className={`relative rounded-xl p-6 border transition-all duration-300 flex flex-col overflow-hidden group hover:shadow-lg ${isActive
                            ...
                            >
                                ...
                                <div className="mb-4 relative z-10">
                                    <h3
                                        className={`font-bold text-lg mb-2 ${isActive
                                                ? "text-blue-400"
                                    ...
                                    <p
                                        className={`text-xs leading-relaxed h-10 ${isActive
                                                ? "text-blue-300/80"
                                ...
                                <div className="space-y-3 mb-6 flex-1 relative z-10">
                                    {p.features.map((feature, i) => (
                                        ...
                                        >
                                            <Check
                                                className={`h-3.5 w-3.5 shrink-0 mt-0.5 ${isActive
                                                        ? "text-blue-400"
                                ...
                                >
                                    <Button
                                        ...
                                        className={`w-full text-xs font-semibold h-10 rounded-lg transition-all ${isActive
