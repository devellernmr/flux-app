            ...
            <div className="space-y-1.5">
              {filteredLinks.map((item) => (
                <button
                  ...
                  className={`w-full group flex items-center gap-3 px-4 py-3 rounded-2xl text-[13px] font-bold transition-all duration-300 relative overflow-hidden ${
                    activeTab === item.id
                ...
                >
                  ...
                  {item.id === "approvals" && pendingApprovalsCount > 0 && (
                    <span
                      className={`ml-auto relative z-10 text-[10px] font-black px-2 py-0.5 rounded-full ${activeTab === item.id ? "bg-black text-white" : "bg-blue-600 text-white"}`}
                    >
                      {pendingApprovalsCount}
                    </span>
                  )}
      ...
      <div className="bg-zinc-900/20 rounded-[28px] p-3 border border-white/5 flex items-center gap-3 group transition-all">
        ...
        <div className="flex-1 overflow-hidden min-w-0">
          ...
          <div className="flex items-center gap-1">
            ...
            <span className="text-[9px] text-zinc-600 font-black uppercase tracking-widest group-hover:text-blue-500 transition-colors">
              Pro Node
            </span>
          </div>
        </div>
