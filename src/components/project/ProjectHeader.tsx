      ...
      <div className="flex items-center gap-6 overflow-hidden">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex items-center gap-3">
            <h1 className="text-lg md:text-3xl font-black text-white tracking-tighter truncate max-w-[200px] md:max-w-xl">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            className={`h-11 w-11 rounded-xl transition-all border ${
              isActivityOpen
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="ghost"
                size="icon"
                className="h-11 w-11 rounded-xl bg-zinc-900/40 border border-zinc-800/80 text-zinc-500 hover:text-white hover:border-zinc-700 transition-all"
              >
            ...
            >
              <DropdownMenuLabel className="text-[10px] font-black uppercase tracking-widest text-zinc-500 px-3 py-2">
                Node Operations
              </DropdownMenuLabel>
              ...
              <div className="px-3 py-2">
                <span className="text-[9px] font-black text-zinc-600 uppercase tracking-[0.2em] block mb-1">
                  Target Deadline
                </span>
