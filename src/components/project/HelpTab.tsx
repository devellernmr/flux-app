  ...
  const categories = [
    {
      ...
      items: [
        {
          q: "Fluxs (Dashboard)",
          a: "Visão geral com prazos, briefing e central de ajuda.",
        },
        {
          q: "Docs (Briefing)",
          a: "Documentação completa e aprovações do briefing.",
        },
        {
          q: "Brand (Brand Kit)",
          a: "Cores, logos e tipografia extraídos da sua marca.",
        },
        {
          q: "Tasks (Entregas)",
          a: "Central de aprovação de arquivos e feedbacks.",
        },
        {
          q: "Cloud (Arquivos)",
          a: "Todos os assets do projeto organizados e seguros.",
        },
        {
          q: "Fin (Financeiro)",
          a: "Controle de lucros, orçamentos e meta de valor/hora.",
        },
        {
          q: "Team (Membros)",
          a: "Gestão de equipe e níveis de acesso ao projeto.",
        },
      ],
    },
    {
    ...
    <div className="max-w-[1000px] mx-auto space-y-8 animate-in fade-in duration-700 pb-24">
      ...
      <div className="relative p-12 rounded-[40px] bg-zinc-950 border border-white/5 overflow-hidden group">
        ...
        <div className="relative z-10 space-y-4">
          ...
          <h2 className="text-4xl font-black text-white tracking-tighter leading-none">
            Como podemos <span className="text-blue-500">acelerar</span> seu
            trabalho hoje?
          </h2>
          <p className="text-zinc-500 max-w-xl font-medium leading-relaxed">
            Bem-vindo à central de suporte do Fluxs. Aqui você entende nossas
            métricas de alta performance e aprende a extrair o máximo da nossa
            IA.
          </p>
          <div className="pt-2">
            <Button
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {categories.map((cat, idx) => (
          ...
          >
            <div
              className={`w-12 h-12 ${cat.bg} rounded-2xl flex items-center justify-center`}
            >
      ...
      <div className="p-8 rounded-[32px] bg-gradient-to-br from-blue-600 to-purple-600 flex flex-col md:flex-row items-center justify-between gap-6 shadow-2xl shadow-blue-500/10 border border-white/20">
        <div className="space-y-1 text-center md:text-left">
          ...
          <p className="text-white/70 text-sm font-medium">
            Nossa equipe de suporte técnico está pronta para te ajudar a
            qualquer momento.
          </p>
        </div>
        <button
          ...
          <div className="space-y-6 mt-6">
            ...
            <div className="p-6 rounded-2xl bg-zinc-900/50 border border-zinc-800 space-y-4">
              ...
              <div className="space-y-3">
                <div>
                  <Label htmlFor="subject" className="text-zinc-400 text-xs">
                    Assunto
                  </Label>
                  <Input
                    id="subject"
                ...
                <div>
                  <Label htmlFor="message" className="text-zinc-400 text-xs">
                    Mensagem
                  </Label>
                  <Textarea
                    id="message"
